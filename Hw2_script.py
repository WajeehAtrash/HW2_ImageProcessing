...
if __name__ == "__main__":
    ...
    ims_low = createMorphSequence(face1_gray, imagepts1, face2_gray, imagepts2, np.linspace(0, 1, 3),0)
    ...
    ims_high = createMorphSequence(face1_gray, imagepts1, face2_gray, imagepts2, np.linspace(0, 1, 3),0)
    plt.figure()
    plt.subplot(1, 3, 1)
